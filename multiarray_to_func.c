/* Demonstrates passing a pointer to a multidimensional array 
 * to a function */
...
void printarray_1(int (*ptr)[4])
{
	 ...
	 * p is a pointer to type int. You must use a typecast to make p equal 
	 * to the address in ptr. */
